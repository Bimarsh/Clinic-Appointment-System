...
<body>
	...
	<div id="main">
		<div id="prescription-tools" class="tools">
		...
		<div id="prescription-modal" class="modal">
			<div class="modal-content">
				...
				<p>
					...
					<textarea type="text" id="symptomps" name="symptomps" rows="3"></textarea>
				</p>
				<p>
					<label for="diagnosis" class="field-label">Diagnosis</label>
					<textarea type="text" id="diagnosis" name="diagnosis" rows="3"></textarea>
				</p>
				<p>
					<label for="medication" class="field-label">Medication</label>
					<textarea type="text" id="medication" name="medication" rows="3"></textarea>
				</p>
				<p>
					<label for="dosages" class="field-label">Dosage</label>
					<textarea type="text" id="dosages" name="dosages" rows="3"></textarea>
				</p>
